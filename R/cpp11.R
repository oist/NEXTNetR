...
episimR_graph_size <- function(nw) {
  .Call(`_episimR_episimR_graph_size`, nw)
}

episimR_graph_is_undirected <- function(nw) {
  .Call(`_episimR_episimR_graph_is_undirected`, nw)
}
...
episimR_nextreaction_simulation_meanfield <- function(N, R0, psi, rho_, opts) {
