...
```{r}
N2 <- 2500
nw2 <- brownian_proximity_temporalnetwork(N2, avg_degree=4, D0=2, radius=1, dt=0.05)
```
...
We then proceed as for the lattice and to create an animation depicting the spread of the network.
...
events2 <- list()
i <- 0
for(t1 in seq(from=0, to=60, by=0.5)) {
  i <- i + 1
