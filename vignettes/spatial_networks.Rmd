...
```{r}
N2 <- 2500
nw2 <- brownian_proximity_temporalnetwork(N2, avg_degree=4, D0=1.0, radius=1, dt=0.05)
```
...
We then proceed as for the lattice and create an animation depicting the spread of the network.
...
A log-plot of the number of infected node shows that contrary to the case of a lattice, the number of infected nodes initially grows exponentially again on the Brownian proximity network.
